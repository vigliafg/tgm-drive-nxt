#!/usr/bin/env bash
# TGM Drive — Build eseguibile standalone con PyInstaller (macOS)
...
echo -e "${BOLD}🔨 TGM Drive — Build PyInstaller (macOS)${NC}\n"
...
pyinstaller \
    ...
    --noconfirm \
    --osx-bundle-identifier com.tgmdrive.app \
    main.py
...
if [ -f "$DIST_DIR/$EXE_NAME" ]; then
    ...
    echo -e "\n   Per creare un .app bundle aggiungi --windowed al comando pyinstaller"
else
